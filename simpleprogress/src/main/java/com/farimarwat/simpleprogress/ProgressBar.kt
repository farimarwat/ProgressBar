package com.farimarwat.simpleprogress
...
class ProgressBar(context:Context, attrs:AttributeSet) : View(context,attrs) {
    ...
    init {
        ...
        mStroke = ta.getFloat(R.styleable.ProgressBar_sp_stroke, DEFAULT_STROKE)
        progress = ta.getInt(R.styleable.ProgressBar_sp_progress,0)
        backgroundPaint.color = ta.getColor(R.styleable.ProgressBar_sp_backgroundcolor,Color.GRAY)
        backgroundPaint.style = Paint.Style.STROKE
        backgroundPaint.strokeWidth = mStroke
        backgroundPaint.strokeCap = Paint.Cap.ROUND

        progressPaint.color = ta.getColor(R.styleable.ProgressBar_sp_progresscolor,Color.GREEN)
